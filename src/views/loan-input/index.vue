<template>
	<div>
					...
					<el-col :xs="24" :sm="12" :md="8" :lg="6">
						<el-form-item label="教育程度" prop="education">
							<el-select v-model="temp.education" class="filter-item" placeholder="Please select">
								<el-option v-for="item in educationOptions" :key="item.key" 
									:label="item.display_name" :value="item.key" />
							</el-select>
						</el-form-item>
					</el-col>
        ...
        <el-button type="primary" @click="submitForm('temp')">保存</el-button>
...
import {sexOptions,marriageOptions,educationOptions,companyOptions} from "@/utils/selectData";
